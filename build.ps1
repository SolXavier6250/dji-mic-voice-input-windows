...
& $compiler /nologo /codepage:65001 /target:winexe /r:System.Windows.Forms.dll /r:System.Drawing.dll /r:Microsoft.CSharp.dll ('/win32icon:' + $icon) ('/resource:' + $icon + ',AppIcon.ico') ('/out:' + $target) (Join-Path $PSScriptRoot 'src\Program.cs')
